...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-ZiMuZu/YYCache.framework"
  install_framework "Pods-ZiMuZu/YYCategories.framework"
  install_framework "Pods-ZiMuZu/YYImage.framework"
  install_framework "Pods-ZiMuZu/YYModel.framework"
  install_framework "Pods-ZiMuZu/YYWebImage.framework"
fi
