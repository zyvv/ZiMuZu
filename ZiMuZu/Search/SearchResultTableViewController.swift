...
class SearchResultTableViewController: UITableViewController {
    ...
    func reload(type: SearchType, dataArray: [Any]?) {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if searchType == .resource {
            ...
            let tv: TV = dataArray[indexPath.row] as! TV
            cell.posterImageView.kf.setImage(with: tv.poster_b)
            cell.typeLabel.text = tv.customChannel
            cell.nameLabel.text = tv.cnname
            cell.stateLabel.text = tv.play_status
            cell.scoreLabel.text = tv.score
            cell.scoreCountLabel.text = ""
            return cell
        }
